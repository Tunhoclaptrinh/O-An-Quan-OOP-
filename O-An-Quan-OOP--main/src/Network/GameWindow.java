...
//
//        String text0 = Client2.getPlayer2Name()+ " :Player2 ";
////        String textScore2 = Server.Player2sum() +  "  : Score " ;
...
////        g.drawString(" Score: "  + Server.Player1sum(), 3, 90);
////        g.drawString(Server.Player2sum() + "  : Score" , Consts.WIDTH - textWidthScore, 90);
//
//
//
...
//            g.drawString("Current Turn Player: " + Server.getPlayer1Name(), Consts.WIDTH/2 - textWidth1/2 , Consts.HEIGHT/4 - textHeight /*- ODan.HEIGHT*/);
//        }
//        else if (Server.currentPlayer == 1) {
//            g.drawString("Current Turn Player: " + Server.getPlayer1Name() , Consts.WIDTH/2 - textWidth2/2, Consts.HEIGHT/4 - textHeight /*- ODan.HEIGHT*/);
//        }
//
...
//                    Test_LOGIC.isWaitingForInput = true; // Gửi tín hiệu tới logic
//
//                }
//            }
//
