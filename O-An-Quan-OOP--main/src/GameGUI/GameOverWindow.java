...
public class GameOverWindow extends JFrame {
    public GameOverWindow(String player1Name, int player1Score, String player2Name, int player2Score) {
        setTitle("GAME OVER");
        setSize(400, 300);
    ...
    public static void showGameOverWindow(String player1Name, int player1Score, String player2Name, int player2Score) {
        SwingUtilities.invokeLater(() -> {
            GameOverWindow gameOverWindow = new GameOverWindow(player1Name, player1Score, player2Name, player2Score);
